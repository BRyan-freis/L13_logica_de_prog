...
<body>
    ...
    foreach ($idades as $nome => $idade) {
       ...
       //Loop, ele acessa a array associativa e reditribui os valores da variável Idades que é também uma array associativa para as duas outras variáveis $nome e $idade.//
